// src/components/Footer.jsx - Updated with Modern Premium UI
...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden mt-16">
