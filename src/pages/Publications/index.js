...
const PublicationCard = ({ publication, onClick }) => {
  return (
    <motion.div
      whileHover={{ y: -10 }}
      transition={{ duration: 0.3 }}
      className="bg-[#1a2535] rounded-xl shadow-xl overflow-hidden h-full flex flex-col border border-gray-700 cursor-pointer"
      onClick={() => onClick(publication.id)}
    >
      <div className="relative h-64 w-full overflow-hidden">
        <Image
      ...
      >
        <div className="relative">
          ...
          <div className="p-6">
            ...
            <div className="flex justify-end mt-8">
              <button 
                className="bg-blue-900 text-blue-300 border border-blue-700 px-6 py-2 rounded-lg hover:bg-blue-800 transition-colors"
                onClick={() => {
      ...
      <Layout>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-300">Loading publications...</p>
          </div>
        </div>
      </Layout>
    );
