...
//           <div className="absolute top-[10%] -right-[10%] w-[50%] h-[50%] bg-gradient-to-br from-indigo-400/20 to-pink-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
//           <div className="absolute bottom-[10%] left-[20%] w-[40%] h-[40%] bg-gradient-to-br from-emerald-400/20 to-teal-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }}></div>
//         </div>
...
//               <div className="flex items-center justify-between mb-4">
//                 <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${stat.color} flex items-center justify-center text-white group-hover:scale-110 transition-transform duration-300 shadow-lg`}>
//                   {stat.icon}
//                 </div>
//                 <div className="text-right">
...
//               <div className={`mt-3 h-1 bg-gradient-to-r ${stat.color} rounded-full shadow-lg`}></div>
//             </div>
//           </motion.div>
//         ))}
//       </motion.div>
...
//           <div>
//             <div className={`bg-gradient-to-r ${currentStat?.color || 'from-blue-500 to-purple-500'} h-1.5 w-24 mb-4 rounded-full shadow-lg`}></div>
...
//             <div className={`w-24 h-24 rounded-full bg-gradient-to-br ${currentStat?.color || 'from-blue-500 to-purple-600'} flex items-center justify-center mx-auto mb-8 shadow-lg`}>
//               <span className="text-4xl">{currentStat?.icon}</span>
//             </div>
...
//                 <div className="bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 h-1 w-16 rounded-full shadow-lg"></div>
//               </div>
//               <nav className="space-y-2">
//                 {navigationItems.map((item) => (
//                   <button
